                            ...
                            <div class="content">
                                <div class="heading  cd-headline clip is-full-width">
                                    ...
                                    <h3 class="cd-words-wrapper text-color-3">
                                        ...
                                        <b> <span class="gold-title">4+ Year Experience</span></b>
                                    </h3>
                                    <p>I'm passionate about teaching</p>
                                </div>
                                <div class="flat-bt-slider">
                                    <div class="sc-btn-top">
                                        <a href="#" class="btn-action"><span>Let's Start
                                                    </span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="image">
                                <img class="" src="assets/bg.png" alt="">
                                ...
                                <div class="icon-slider">
                                    <!-- <i class="fa fa-code 2x" style="color: white; width="400" height="35"" ></i> -->

                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-code" width="140" height="122" viewBox="0 0 40 35"  stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
